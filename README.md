...
links:
  ...
  - research/07-experiment-report.md
  - pyonto/README.md
  - lit/MISSING.md
---
...
| [`research/`](research/README.md) | документы двух волн исследования; актуальные: Э1 форматы+курс+постановка, Э2 методика синтеза НЗ и релаксации, Э3 план эксперимента с метриками, **Э4 сводный отчёт эксперимента** ([07-experiment-report.md](research/07-experiment-report.md)) |
