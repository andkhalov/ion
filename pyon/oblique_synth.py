...
OB_CLASSES = ["BG", "F2", "F1", "E", "Es", "MH", "X"]  # MH = кратник основного следа (2 скачка F2);
# X = следы необыкновенной волны (на реальном НЗ-снимке чирп-зонда O и X лежат в одной картинке).
# Отдельный класс введён 2026-09-07: без него модель метила X-след как кратник MH (диагностика на
# реальных снимках Тромсё), что и завышало МПЧ(2F2) и ловилось гейтом (форма S1).
